...
@Table(name="parking_slot", uniqueConstraints= {
        @UniqueConstraint(columnNames = {"id_neighborhood", "slot_ident"}),
...
public class ParkingSlot {
    ...
    @JsonBackReference
    @JoinColumn(name="id_neighborhood", nullable=false)
    ...
    public ParkingSlot(String slotIdent, int state, double latitude, double longitude, Neighborhood neighborhood) {
